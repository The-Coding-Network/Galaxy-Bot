...
module.exports = {
    ...
    execute(client, msg, args) {
        ...
        if(!msg.author.id === '678240766790729728' || !msg.author.id === '721416593166303352') return msg.reply('You do not have permission to use this command!').then(msg => msg.delete({timeout: 60000}));
